...
gcloud_destroy() {
  ...
  echo ""
  echo "${bold}${red}deleting instances...${reset}"
  ...
  echo ""
  echo "${bold}${red}deleting firewall rules...${reset}"
  ...
  echo ""
  echo "${bold}${red}deleting subnets...${reset}"
  ...
  echo ""
  echo "${bold}${red}deleting vpc...${reset}"
